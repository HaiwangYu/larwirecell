...
namespace WireCell::QLMatch {
  ...
  private:
    ...
    bool m_pmts{true};
    bool m_data{true};
    std::vector<int> m_ch_mask{39,  64,  66,  71,  85,  86,  87, 115, 138, 141,
                               197, 217, 221, 222, 223, 226, 245, 249, 302};
    ...
    // dropped after each matching round. Pulled out so the cutoff can be
    // widened/narrowed from the jsonnet without rebuild.
